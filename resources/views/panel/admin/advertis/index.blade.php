            ...
            <div class="row g-2 items-center flex justify-between">
                ...
                <div class="col !text-end">
                    <a class="btn btn-primary"
                        href="{{ route('dashboard.admin.settings.affiliate') }}">{{ __('Settings') }}</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @foreach ($advertises as $advertis)
                                <tr>
                                    ...
                                    <td class="sort-status">
                                        @if ($advertis->status)
                                            <span class="bg-green-700/80 text-white text-center p-1 rounded-lg">
                                                Active
                                            </span>
                                        @else
                                            <span class="bg-red-700/80 text-white text-center p-1 rounded-lg">
                                                Passive
                                            </span>
                                        @endif
                                    </td>
                                    <td>
                                        <a class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white"
