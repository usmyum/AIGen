        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <form id="settings_form" onsubmit="return serperSettingsSave();" enctype="multipart/form-data">
                            ...
                            @if ($app_is_demo)
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="serper_api_key"
                            ...
                            @else
                                <div class="col-md-12">
                                    <div
                                        ...
                                        <label class="form-label">{{ __('Serper API Key') }}</label>
                                        <input type="text" class="form-control" id="serper_api_key"
                                            name="serper_api_key" value="{{ $settings_two->serper_api_key }}" required>
                                        {{-- <div
                        ...
                        <a href="https://serper.dev" target="_blank">{{ __('Get Serper Api Key') }}</a>
