...
@section('content')
        ...
        <div class="container-xl">
            <div class="items-center row g-2">
                <div class="col">
                    ...
                    <p class="mb-2">{{ __('Manage Chat Categories') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="pt-6 page-body">
        <div class="container-xl">
            <div class="mb-2">
                <a @if ($app_is_demo) onclick="return toastr.info('This feature is disabled in Demo version.')" @else href="{{ LaravelLocalization::localizeUrl(route('dashboard.admin.openai.chat.addOrUpdateCategory')) }}" @endif
                    class="btn btn-success">{{ __('Add Category') }}</a>
            </div>
            <div class="card">
                            ...
                            @foreach ($list as $entry)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap text-right">
                                        ...
                                        @else
                                            <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.admin.openai.chat.addOrUpdateCategory', $entry->id)) }}"
                                                class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white"
                                                title="{{ __('Edit') }}">
                                                <svg width="13" height="12" viewBox="0 0 16 15" fill="none"
                                                    stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.admin.openai.chat.deleteCategory', $entry->id)) }}"
