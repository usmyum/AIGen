                            ...
                            @foreach ($list as $entry)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap">
                                        ...
                                        @else
                                            <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.admin.openai.chat.addOrUpdate', $entry->id)) }}"
                                                class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white"
                                                title="{{ __('Edit') }}">
                                                <svg width="13" height="12" viewBox="0 0 16 15" fill="none"
                                                    stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.admin.openai.chat.delete', $entry->id)) }}"
