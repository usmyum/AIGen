                ...
                <div id="table-default" class="card-table table-responsive">
                    <table class="table">
                        ...
                        @foreach($list as $entry)
                            <tr>
                                <td class="sort-name">
                                    <a target="_blank" class="text-heading font-normal" href="{{ LaravelLocalization::localizeUrl( url('/blog', $entry->slug) ) }}">
                                        {{$entry->title}}
                                    </a>
                                </td>
                                <td class="sort-name">
                                    @if($entry->category)
                                        ...
                                        <a target="_blank" class="text-heading font-normal" href="{{ LaravelLocalization::localizeUrl( url('/blog/category', $cat) ) }}">{{$cat}}</a>
                                        @endforeach
                                    @endif
                                </td>
                                <td class="sort-name">
                                    @if($entry->tag)
                                        ...
                                        <a target="_blank" class="text-heading font-normal" href="{{ LaravelLocalization::localizeUrl( url('/blog/tag', $tag) ) }}">{{$tag}}</a>
                                        @endforeach
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a target="_blank" class="text-heading font-normal" href="{{ LaravelLocalization::localizeUrl( url('/blog/author', $entry->user_id) ) }}">{{App\Models\User::where('id', $entry->user_id)->first()->name;}}</a>
                                </td>
