                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xl-12">
                                        ...
                                        <div class="pt-2 !text-end">
                                            <button @if($app_is_demo) type="button" onclick="return toastr.info('This feature is disabled in Demo version.')" @else type="submit" @endif id="card-button" data-secret="{{ $intent->client_secret }}" class="btn btn-success">
                                                {{__('Pay')}} 
                ...
                <div class="col-sm-4 col-lg-4">
                    <div class="card card-md">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="text-uppercase text-muted font-weight-medium mb-2">{{__(formatCamelCase($plan->frequency))}} {{__('PAYMENTS')}}</div>
