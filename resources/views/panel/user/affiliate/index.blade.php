                        ...
                        <div class="card-body p-10">
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <h4 class="w-10/12 mb-10 text-[20px] leading-[1.3em]">
                                ...
                                <div
                                    class="col-12 col-md-4 ms-auto text-center text-heading font-semibold max-md:-order-1 max-md:!text-start max-md:mb-3">
                                    ...
                                    <p class="mb-0"><span class="opacity-60">{{ __('Comission Rate') }}:</span>
                                        {{ $setting->affiliate_commission_percentage }}%</p>
                                    <p class="mb-0"><span class="opacity-60">{{ __('Referral Program') }}:</span>
                                        {{ __('All Purchases') }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-heading">
                        <div class="card-body flex flex-col py-6 px-8">
                            ...
                            <ol class="list-none p-0 ml-0 mb-7">
                                <li class="mb-[18px]">
                                    <span
                                        class="inline-flex items-center justify-center w-[26px] h-[26px] me-[1em] bg-[rgba(var(--tblr-primary-rgb),0.2)] text-primary rounded-2xl">
                                ...
                                <li class="mb-[18px]">
                                    ...
                                    {!! __('<strong>They subscribe</strong> to a paid plan by using your referral link.') !!}
                                </li>
                                <li class="mb-[18px]">
                                    <span
                                        class="inline-flex items-center justify-center w-[26px] h-[26px] me-[1em] bg-[rgba(var(--tblr-primary-rgb),0.2)] text-primary rounded-2xl">
                            ...
                            <form id="send_invitation_form" onsubmit="return sendInvitationForm();">
                                <div class="flex items-center relative">
                                    <input class="form-control h-10" type="email" name="to_mail" id="to_mail"
                                ...
                                <button type="submit" id="send_invitation_button" form="send_invitation_form"
                                    class="btn btn-primary mt-2 w-100 rounded-[10px]">{{ __('Send') }}</button>
                            </form>
                            ...
                            <form id="send_request_form" onsubmit="return sendRequestForm();">
                                <div class="mb-[15px]">
                                    <label class="form-label"
                                        for="affiliate_bank_account">{{ __('Your Bank Information') }}</label>
                                    <textarea class="form-control" rows="2" name="affiliate_bank_account" id="affiliate_bank_account"
                                        placeholder="{{ __('Bank of America - 2382372329 3843749 2372379') }}">{{ Auth::user()->affiliate_bank_account ?? null }}</textarea>
                                </div>

                                <div class="mb-[20px]">
                                    <label class="form-label" for="affiliate_bank_account">{{ __('Amount') }}</label>
                                    <input type="number" class="form-control h-10" name="amount" id="amount"
                                        min="{{ $setting->affiliate_minimum_withdrawal }}"
                                        placeholder="{{ __('Minimum Withdrawal Amount is') }} {{ $setting->affiliate_minimum_withdrawal }}">
                                </div>

                                <button type="submit" id="send_request_button" form="send_request_form"
                                    class="btn btn-primary w-100 rounded-[10px]">{{ __('Send Request') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <th><button class="table-sort"
                                                    data-sort="sort-id">{{ __('No') }}</button></th>
                                            <th><button class="table-sort"
                                                    data-sort="sort-amount">{{ __('Amount') }}</button></th>
                                            <th><button class="table-sort"
                                                    data-sort="sort-status">{{ __('Status') }}</button></th>
                                            <th><button class="table-sort"
                                                    data-sort="sort-date">{{ __('Date') }}</button></th>
                                        </tr>
                                    </thead>
                                        ...
                                        @if (count($list) == 0)
                                            <tr>
                                                <td colspan="4" class="text-center">
                                                    {{ __('You have no withdrawal request') }}</td>
                                            </tr>
                                        @endif
