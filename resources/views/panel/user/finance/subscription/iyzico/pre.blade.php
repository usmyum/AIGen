        ...
        <div class="row row-cards">
            <div class="col-sm-8 col-lg-8">
                <div class="flex flex-col justify-content-center text-center">
                    ...
                    <form class="" action="{{ route('dashboard.user.payment.subscription.checkout', ['gateway' => 'iyzico']) }}" method="POST">
                        @csrf
                            ...
                            <div class="sm:w-1/2 w-full">
                                <div class="max-w-sm flex flex-col gap-3">
                                    ...
                                    <div class="flex flex-col justify-start text-start">
                                        ...
                                        <input type="text" class="form-control" id="surname" name="surname" required value="{{old('surname')?? auth()->user()->surname}}">
                                    </div>
                                    <div class="flex flex-col justify-start text-start">
                                    ...
                                    <div class="flex flex-col justify-start text-start">
                                        ...
                                        <input type="tel" class="form-control" id="gsmNumber" name="gsmNumber" value="{{old('gsmNumber')?? auth()->user()->phone}}" required>
                                    </div>
                                    <script>
                            ...
                            <div class="sm:w-1/2 w-full">
                                <div class="max-w-sm flex flex-col gap-3">
                                    ...
                                    <div class="flex flex-col justify-start text-start">
                                        ...
                                        <input type="text" class="form-control" id="registrationAddress" value="{{old('registrationAddress')?? auth()->user()->address}}" name="registrationAddress" required>
                                    </div>
                                    <div class="flex flex-col justify-start text-start">
                        ...
                        <button 
                            ...
                            class="btn w-full border mt-4">
                            <span id="button-text">
                                {{__('Continue to Payment with')}} <img class="px-2" src="/assets/img/payments/iyzico.svg" height="40" alt="banktransfer">
                            </span>
                        </button>
                    </form>
                    <p></p>
