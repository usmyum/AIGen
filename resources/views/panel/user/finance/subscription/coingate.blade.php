        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-sm-8 col-lg-8">
                    ...
                    <form  action="{{ route('dashboard.user.payment.subscription.checkout' , ['gateway' => 'coingate']) }}" method="post">
                        @csrf
                        <input type="hidden" name="planID" value="{{ $plan->id }}">
                        <input type="hidden" name="orderID" value="{{ $order_id }}">
                        <input type="hidden" name="gateway" value="coingate">
                        <div class="row">
...
{{--                            </div>--}}
                            <div class="col-md-12 col-xl-12 mt-3">
                                <button 
                                    @if($app_is_demo) type="button" onclick="return toastr.info('This feature is disabled in Demo version.')" @else type="submit" data-bs-toggle="modal" data-bs-target="#confirmationModal" @endif
