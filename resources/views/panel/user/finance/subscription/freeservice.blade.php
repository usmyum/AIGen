        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-sm-8 col-lg-8">
                    ...
                    <form id="bank-form" action="{{ route('dashboard.user.payment.subscription.checkout' , ['gateway' => 'freeservice']) }}" method="post">
                        @csrf
                        <input type="hidden" name="planID" value="{{ $plan->id }}">
                        <input type="hidden" name="orderID" value="{{ $order_id }}">
                        <input type="hidden" name="gateway" value="freeservice">
                        <div class="row">
