        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-sm-8 col-lg-8">
                    ...
                    <form id="bank-form" enctype="multipart/form-data" action="{{ route('dashboard.user.payment.subscription.checkout', ['gateway' => 'banktransfer']) }}" method="post">
                        @csrf
                        <input type="hidden" name="planID" value="{{ $plan->id }}">
                        <input type="hidden" name="orderID" value="{{ $order_id }}">
                        <input type="hidden" name="couponID" id="coupon">
                        <input type="hidden" name="gateway" value="banktransfer">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-12 mt-2">
                                <div class="border p-3 form-control h-auto whitespace-pre-wrap">{!! $gateway->bank_account_other ?? "To facilitate the processing of your transaction, kindly remit your payment directly to our designated bank account. Please ensure to include your Order ID Number as the payment reference to expedite the allocation of funds to your account. Note that services will not be credited until the payment has successfully been received in our bank account. We appreciate your cooperation and thank you for choosing our services." !!}</div>
                            </div>
                            <div class="col-md-12 col-xl-12 mt-2">
                                <div class="border p-3 form-control h-auto whitespace-pre-wrap">{!! $gateway->bank_account_details ?? "Bank Name:\nAccount Name:\nIBAN:\nBIC/Swift:\nRouting Number:\n" !!}</div>
                            </div>
                            <div class="col-md-12 col-xl-12 mt-3">
                                <button 
                                    @if($app_is_demo) type="button" onclick="return toastr.info('This feature is disabled in Demo version.')" @else type="button" data-bs-toggle="modal" data-bs-target="#confirmationModal" @endif
                                    ...
                                    <span id="button-text">
                                        {{ __('Start free trial ') }}
                                        {{ __('with') }} <img src="/assets/img/payments/banktransfer.png" height="40" alt="banktransfer">
                                    </span>
                                    @else
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="proof_image" class="form-label">{{__('Upload Proof of Purchase')}}</label>
