                            ...
                            <div class="form-submit">
                                <button
                                    ...
                                    <span id="button-text">{{ __('Pay') }}
                                        ...
                                        {{ __('with') }} &nbsp;&nbsp;<img src="/images/payment/paystack-2.svg"
                                            height="60" alt="Paystack">
                                    </span>
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="col-sm-4 col-lg-4">
                        <div
                            ...
                            <div class="card-body flex flex-col !p-[45px_50px_50px] text-center">
                                <div class="text-center rounded-[8px] font-medium text-[15px] leading-none text-[#2D3136]">
                                    {{ __($plan->name) }}</div>
                                <div
                                    class="text-heading flex items-end justify-center mt-0 mb-[15px] w-full text-[50px] leading-none">
                                ...
                                <ul class="list-unstyled mt-2 mb-0">
                                    ...
                                    <li class="mb-[0.625em] flex">
                                        ...
                                        <div class="flex-1 text-end">{!! displayCurr(currency()->symbol, $plan->price, 0, $newDiscountedPrice) !!}</div>
                                    </li>
                                </ul>
                                <hr>
