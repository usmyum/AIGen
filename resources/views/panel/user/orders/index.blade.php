					...
					@foreach($list as $entry)
						<tr>
							...
							<td class="sort-status">
								@switch($entry->status)
								@case("Waiting")
									<span class="badge bg-danger">{{__($entry->status)}}</span>
									@break
								@case("Approved")
									<span class="badge bg-primary">{{__($entry->status)}}</span>
									@break
								@case("Rejected")
									<span class="badge bg-warning">{{__($entry->status)}}</span>         
									@break
								@default
									<span class="badge bg-danger">{{__($entry->status)}}</span>     
							@endswitch
							</td>
							<td class="sort-name">{{__(@$entry->plan->name ?? 'Archived')}}</td>
							...
							<td class="sort-type text-capitalize">{{__($entry->type)}}</td>
