                            ...
                            @foreach ($list as $entry)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap text-right">
                                        <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.user.brand.edit', $entry->id)) }}"
                                        ...
                                        @else
                                            <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.user.brand.delete', $entry->id)) }}"
