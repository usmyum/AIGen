                    ...
                    <ul
                        ...
                        <li>
                            <button data-filter-trigger="all"
                                class="inline-flex leading-none p-[0.3em_0.65em] rounded-full bg-[transparent] border-0 text-inherit hover:no-underline hover:bg-black/5 transition-colors [&.active]:bg-black/5 dark:text-[--tblr-muted] dark:[&.active]:bg-[--lqd-faded-out] dark:[&.active]:text-[--lqd-heading-color] dark:hover:bg-white/5 active">
                                {{ __('All') }}
                            </button>
                        </li>
                ...
                @foreach ($list as $item)
                    ...
                    <div data-filter="{{ $item->filters }}"
                        ...
                        @if ($item->active == 1)
                            ...
                            @endif
                            <div
                                class="absolute top-0 left-0 w-full h-full transition-all z-2 @if ($upgrade) bg-[--tblr-body-bg] opacity-75 @endif">
                                @if ($upgrade)
                                    <div
